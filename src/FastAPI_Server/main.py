...
# Constants
USER_MEMORY_INDEX = "Query DB/user_memory.index"
USER_METADATA_FILE = "Query DB/user_metadata.json"

Response_Memory_index = "Query_Response DB/Response_memory.index"
Response_Metadata_file = "Query_Response DB/Response_metadata.json"
...
def intialize_components():
    try:
        faiss_index = faiss.read_index("FAISS DB/knowledge_base_python.index")
        with open("FAISS DB/metadata.json", "r", encoding="utf-8") as f:
